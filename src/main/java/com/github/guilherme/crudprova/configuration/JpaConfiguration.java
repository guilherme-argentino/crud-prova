package com.github.guilherme.crudprova.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.github.guilherme.crudprova.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.github.guilherme.crudprova.model" });
